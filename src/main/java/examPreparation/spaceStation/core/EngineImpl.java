...
import examPreparation.spaceStation.common.Command;
...
public class EngineImpl implements Engine {
    ...
    private String addPlanet(String[] data) {
        List<String> planets = Arrays.asList(data).subList(1, data.length);
        return controller.addPlanet(data[0], planets.toArray(new String[0]));
    }
